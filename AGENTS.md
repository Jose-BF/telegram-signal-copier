...
9. `recursive_log_learning.py` -> `data/log_learning_report.json` and `data/log_pattern_registry.json`
10. `simulation_run_provenance.py` -> `data/simulation_runs/<fingerprint>/run_card.json`
