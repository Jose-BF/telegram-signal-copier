...
TELEGRAM_MEDIA_CAPTURE_ENABLED = (
    os.getenv("TELEGRAM_MEDIA_CAPTURE_ENABLED", "1") == "1"
)
TELEGRAM_MEDIA_MAX_BYTES = int(
    os.getenv("TELEGRAM_MEDIA_MAX_BYTES", str(8 * 1024 * 1024))
)
TELEGRAM_MEDIA_DOWNLOAD_TIMEOUT_S = _float(
    "TELEGRAM_MEDIA_DOWNLOAD_TIMEOUT_S", 30.0
)
TELEGRAM_MEDIA_DOWNLOAD_ATTEMPTS = int(
    os.getenv("TELEGRAM_MEDIA_DOWNLOAD_ATTEMPTS", "2")
)
